...
public class SIMAPLoader : MonoBehaviour {
    ...
    protected string[] selectPatterns = {null,"*.IN3"};
    protected string[] hardDirectories = {"","/Modelout"};
    ...
    protected void OnGUI () {
		...
		if(!selection)
			GUI.Box(new Rect(412,200,200,20), "SIMAP Scenario Loader");
    ...
    protected void FileSelectedCallback(string path) {
        ...
        switch(currentPattern)
        {
        	...
        	case 1:
        		...
        		LoadBathymetry(scenarioPath + "/grids/"+gridFile.Replace(".HAB",".DEP"));
        		zmpPath = path.Replace(".IN3",".LU3");
        		zmlPath = path.Replace(".IN3",".TR3");
        		LoadSpill();
        	break;
